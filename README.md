...
A hands-on lab introducing new virtualization specific features and capabilities found in OpenShift 5, and exploring common and well understood workflows in this new environment.

**Owner:** acowles-redhat
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/ocp5-virt-rh1`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/ocp5-virt-rh1
   ```
3. `cd ocp5-virt-rh1`
